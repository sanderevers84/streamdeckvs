        ...
        public static IEnumerable<EnvDTE.DTE> GetDTE(int? processId = null)
        {
            ...
            try
            {
                ...
                while (monikers.Next(1, moniker, fetchedMonikers) == 0)
                {
                    ...
                    if (rotName.StartsWith("!VisualStudio.DTE.18.0:") || rotName.StartsWith("!VisualStudio.DTE.17.0:") || rotName.StartsWith("!VisualStudio.DTE.16.0:") || rotName.StartsWith("!VisualStudio.DTE.15.0:"))
                    {
